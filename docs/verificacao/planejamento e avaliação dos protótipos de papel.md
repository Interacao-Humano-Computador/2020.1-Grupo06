...
## Introdução
* Técnica utilizada para verificação do planejamento e avaliação dos protótipos de papel foi a técnica de Check-List.

## Check-list
1. O nome dos documentos condizem com a tarefa proposta?
2. Há erro/erros de ortografia e formatação nos documentos?
3. O Planejamento e a Avaliação dos protótipos de papel estão construídos de forma clara e compreensiva?
